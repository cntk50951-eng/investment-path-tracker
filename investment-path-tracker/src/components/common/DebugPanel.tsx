        ...
        <div className="debug-panel-content">
          ...
          <div className="debug-section">
            <label className="debug-label">
              <input
                type="checkbox"
                checked={mockApiError}
                onChange={toggleMockApiError}
              />
          ...
          <div className="debug-section">
            <label className="debug-label">
              <input
                type="checkbox"
                checked={showBlurDebug}
                onChange={toggleBlurDebug}
              />
          ...
          <div className="debug-section">
            <button onClick={resetAll} className="debug-reset-btn">
              🔄 Reset All
            </button>
          </div>
